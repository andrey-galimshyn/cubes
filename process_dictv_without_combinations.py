...
cb2 = Cube(2, {'к' : False, 'й' : True, 'м' : True, 'ц' : True, 'щ' : True, 'ь' : True, })  
cb3 = Cube(3, {'з' : True, 'м' : False, 'н' : True, 'р' : True, 'т' : True, 'ф' : True})  
cb4 = Cube(4, {'е' : True, 'и' : False, 'о' : False, 'ы' : True, 'ъ' : True, 'э' : True})  
cb5 = Cube(5, {'в' : True, 'г' : True, 'а' : True, 'н' : False, 'с' : False, 'х' : True})  
cb6 = Cube(6, {'а' : False, 'и' : True, 'п' : True, 'у' : True, 'ф' : False, 'ю' : True})  
cb7 = Cube(7, {'ё' : True, 'а' : False, 'б' : True, 'е' : False, 'о' : False, 'я' : True})  
cb8 = Cube(8, {'ж' : True, 'л' : True, 'с' : True, 'р' : False, 'ч' : True, 'ш' : True})
'''
...
def collect_words(comb, file_name):
    ...
    combs_string = []
    curr_word = ''
    f = open('check_words_summary.txt', 'w')
    for line in open(file_name):
        curr_word = line.rstrip()
        zztop, alt_comb = collect_word2(curr_word, comb)
        if zztop :
            f.write(curr_word + '\n')
            found_words += 1
